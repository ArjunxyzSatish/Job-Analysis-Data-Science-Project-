...
X_new_dum = pd.get_dummies(X_new, columns = ['Title_Simp', 'Sector','Prime_Location', 'revenue_simp', 'size_simp']).astype('float')
X_new_dum = X_new_dum.reindex(columns = original_columns, fill_value=0.0)
